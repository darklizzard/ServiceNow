/**
 * Name: NCDIT Generate CAB ACAB
 * Run: Weekly
 * Day(run_dayofweek): Wednesday
 * Time: 06:00
 */
...
chg.addEncodedQuery(
  'approval=approved^typeINnormal,expedited^impactIN1,2^stateIN-2^company=7957d510db806300f861e3f3ca9619bb^start_dateBETWEENjavascript:gs.beginningOfLast7Days()@javascript:gs.endOfNextMonth()^ORDERBYstart_date'
);
chg.query();
