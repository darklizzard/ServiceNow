/**
 * Name: NCDIT Generate CAB FSC
 * Run: Weekly
 * Day(run_dayofweek): Sunday
 * Time: 18:00
 */
...
chg.addEncodedQuery(
  'typeINnormal,expedited^stateIN-4,-3^company=7957d510db806300f861e3f3ca9619bb^start_dateBETWEENjavascript:gs.beginningOfLast7Days()@javascript:gs.endOfNextMonth()^ORDERBYstart_date'
);
chg.query();
